...
DS4w8 = int(input("How many games did %s win in the fourth Division Series? " % teams[7]))
LCS1wh = int(input("How many games did the highest ranked team win in the first League Championship Series? "))
LCS1wl = int(input("How many games did the lowest ranked team win in the first League Championship Series? "))
LCS2wh = int(input("How many games did the highest ranked team win in the second League Championship Series? "))
LCS2wl = int(input("How many games did the lowest ranked team win in the second League Championship Series? "))
...
for i in range(0,iterate):
    ...
    WC1 = MLB_WC.WC(4,5,WC1w)
    WC2 = MLB_WC.WC(9,10,WC2w)
    ...
    DS1,DS1_Wins = MLB_DS.DS(1,WC1,DS1w1,DS1w45)
    DS2,DS2_Wins = MLB_DS.DS(6,WC2,DS2w6,DS2w9A)
    DS3,DS3_Wins = MLB_DS.DS(2,3,DS3w2,DS3w3)
    DS4,DS4_Wins = MLB_DS.DS(7,8,DS4w7,DS4w8)
    ...
    LCS1,LCS1_Wins = MLB_LCS.LCS(LCS1_hs,LCS1_ls,LCS1wh,LCS1wl)
    LCS2,LCS2_Wins = MLB_LCS.LCS(LCS2_hs,LCS2_ls,LCS2wh,LCS2wl)
    ...
    WS,WS_Wins = MLB_LCS.LCS(LCS1,LCS2,WSwh,WSwl)
